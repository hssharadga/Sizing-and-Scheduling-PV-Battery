...
function LCC = LCC_5(N_PV,Cb,u); % Cb in kwh
%% one_time calculations
global PV_LCC
global Cb_LCC
...
maximum_discharge=min(0,min(u));
maximum_discharge=-maximum_discharge;
C_inverter_2=maximum_discharge*Cb*1000; % maximum_discharge is [1/hr], Cb is [kWh], and 1000Cb is Wh  the result is W


maximum_charge=max(0,max(u));
C_converter=maximum_charge*Cb*1000;     % maximum_charge is [1/hr], Cb is [kWh], and 1000Cb is Wh  the result is W
C_Con=C_converter; 
