...
% The values in the manufacturer datasheet are given for one module (Ns=1, Np=1), thus to calculate the other varaibles at standered condtion (the varaibles are Ipvn, Ion, Rs, Rshn, n), we assume (Ns=1, Np=1) 

% Also to calculate those varaibles at the different weather condtions (G,T), we assume (Ns=1, Np=1)

% The effect of Ns and Np will be only applied on the final equation (I-V) which is written in term of lambert w function
