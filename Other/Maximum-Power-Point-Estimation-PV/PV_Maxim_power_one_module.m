% This function calculate the maximum power of (one) PV module at given operating conditions (G,T)
...
function [Pmax,Vmax] =PV_Maxim_power_one_module(G,T)
global Im
global Vm
global Isc_n
global  Voc_n
...
%%
% Note Ns_=Ns*Nc_m_s,but Ns=1 thus Ns_=1*Nc_m_s=Nc_m_s
