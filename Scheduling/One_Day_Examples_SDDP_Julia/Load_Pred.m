...
% Note: for explanation and notations see PV-Pred function
...
T=180*hrs; % 255 days (255 days in a year after remving the first 3 days and the weekends, see script: Loading_and_Cleaning): 180 for training and 75 for testing
...
ARIMA_Close1 = arima(hrs,1,hrs); % ARIMA forecasting model
