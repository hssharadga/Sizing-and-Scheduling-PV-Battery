...
CSV.write("C:\\Users\\hssharadga\\Desktop\\Github\\Scheduling\\One Day Examples SDDP (Julia)\\uu_updated.csv", Tables.table(uu_'), writeheader = false)
