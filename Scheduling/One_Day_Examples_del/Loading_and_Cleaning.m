...
Load_15=Load_0(1:end-5*96);% -5*96 to exclude the last 5 days; the year will be 360 days
...
PV__=PV_;
PV__(gg_)=[];% The PV power between 6 am and 6 pm (without ignoring the weekends, and without ignoring the firsit 3 days; thus 360 days)
