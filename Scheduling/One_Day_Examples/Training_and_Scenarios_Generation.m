...
global per_Load;           % per = percentiles , percentiles represent the scenarios in this work (scenarios are used by Stochastic Dual Dynamic Programming)
per_Load=cell(1,hrs);      % 15 sets is explained by the forecasting with receding horizon (15 receding actions)
